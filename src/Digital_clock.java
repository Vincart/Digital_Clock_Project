...
public class Digital_clock extends JFrame {
    ...
    public Digital_clock() {
        ...
        timeLabel.setFont(new Font("Impact", Font.BOLD, 60));
        ...
        JComboBox selectzones = new JComboBox(timezones);


        // Add the time and date labels to the panel
        panel.add(timeLabel, BorderLayout.CENTER);
        panel.add(dateLabel, BorderLayout.SOUTH);
        panel.add(selectzones, BorderLayout.NORTH);
